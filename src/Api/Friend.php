...
class Friend extends Base
{
    ...
    {
        return $this->sendRequest('friend/add.action', [
            'accid' => $accid,
            'faccid' => $faccid,
            'type' => $type,
            'msg' => $msg,
    ...
    {
        return $this->sendRequest('friend/update.action', [
            'accid' => $accid,
            'faccid' => $faccid,
            'alias' => $alias,
            'ex' => $ex,
    ...
    {
        return $this->sendRequest('friend/delete.action', [
            'accid' => $accid,
            'faccid' => $faccid,
    ...
    {
        return $this->sendRequest('friend/get.action', ['accid' => $accid, 'updatetime' => $updatetime]);
    }
    ...
    {
        return $this->sendRequest('user/listBlackAndMuteList.action', ['accid' => $accid]);
    }
}
